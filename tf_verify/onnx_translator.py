...
class ONNXTranslator:
	...
	def translate(self):
		...
		for node in self.nodes:
			...
			# Gather is for the moment solely for shapes
				...
				# print("Gather in tranlate() function")
	...
	def reshape_adjust(self, element, matrix, is_right=False):
		if self.get_kind(element) in ['Reshape', 'Flatten']: #TODO check whether it should be triggered for Flatten layers to
...
if __name__ == '__main__':
	tf_file = '/home/zhongyy/Verifier_nn/ERAN/test_nns/cifar_nns/ResNetTiny_PGD.onnx'
